# 2- Создайте программу для игры с конфетами человек против интеллектуального бота.
# b) Подумайте как наделить бота ""интеллектом""

from random import randint as ri

total_candy = ri(29,110)
take_candy = 0
...
def player_turn():
    ...
    print(f'\nХод Игрока 1. На столе {total_candy} конфет')
...
def bot_turn():
    ...
    take_candy = total_candy % 29 if total_candy % 29 !=0 else ri(1, 28)
    total_candy -= take_candy
